...
import org.w3c.dom.E 
  ort org.w3c.dom.N   lic class Affiche {  public static void main(String[] args) throws Exception {
    ...
    Element element     = (Elem en t) nodeList.item( 0);  // de le 1er satria iray ihany ny path-after-WEB-INF
    String path     = element.getTextContent();
    System.out.println(path);
    nodeList     = rootElement.getElementsByTagName("package-root");
    element     = (Elem en t) nodeList.it
